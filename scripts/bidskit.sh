...
#SBATCH --job-name=foundations_bidskit ## When you run squeue -u  this is how you can identify the job
#SBATCH --output=output.log ## standard out and standard error goes to this file

# A regular comment in Bash

module load dcm2niix
bidskit -d /projects/b1108/studies/foundations/data/raw/neuroimaging/bids/sourcedata
