### Adaption of Ellyn's script for HARP files
###
### Ellyn Butler, Kat Seitz
### Sep 20, 2022
...
parser.add_argument('-i', default='/projects/b1108/data/Georgia/foundations/derivatives/sourcedata/')
#set destination directory
parser.add_argument('-o', default='/projects/b1108/studies/foundations/data/raw/neuroimaging/bids')
...
def curate_scan(sub, ses, scan, indir):
    ...
    if ndicoms > 10:
        ...
        #TODO: this looks MWMH specific? Can this be deleted for the time being?        
